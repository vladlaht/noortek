$(document).ready(function () {
    ...
    $('#firstname, #lastname').keypress(function () {
        return /[a-z, а-яё]/i.test(event.key)
    });

    $('.datepicker-here').datepicker({

       language: $('.lang-item-ru.current-lang').length ? 'ru' : 'ee',
        maxViewMode: 2,
        clearBtn: true,
        autoClose: true,
        todayHighlight: true,
        ...
        if (stepNumber === 2) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    date: inputDate.val(),
                    roomm: $('input[name=room]:checked').val()
    ...
    $.validator.addMethod('isValidTime', function (value) {
