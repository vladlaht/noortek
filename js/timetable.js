!function (e, t) {
    ...
    var t = "Width", n = "Height", o = "Top", r = "Left", i = "scroll", a = "client", s = [], c = function () {
        ...
        for (e = 0; e < f.length; e++) if (u = 0, l = f[e], d = l.getAttribute("name")) {
            for (l = l.scroller || l, s[d] || (s[d] = []), c = 0; c < s[d].length; c++) s[d][c] == l && (u = 1);
            u || s[d].push(l), l.eX = l.eY = 0, function (e, c) {
                e.addEventListener("scroll", e.syn = function () {
                    var l, u, d = s[c], f = e[i + r], h = e[i + o], p = f / (e[i + t] - e[a + t]),
                        m = h / (e[i + n] - e[a + n]), v = 0, E = 0;
...
Timetable.Renderer = function (e) {
    ...
    function i(e, t) {
        var n = e instanceof Date && t instanceof Date, o = e < t;
        return n && o
    }
    ...
    Timetable.prototype = {
        ...
        draw: function (e) {
            ...
            function r(e) {
                var t = e.appendChild(document.createElement("section")), n = i(t),
            ...
            function d(e, t) {
                ...
                var s = n ? "a" : "span", c = t.appendChild(document.createElement(s)),
                    l = c.appendChild(document.createElement("small"));
                if (c.title = e.name, n && (c.href = e.options.url), r) for (var u in e.options.data) c.setAttribute("data-" + u, e.options.data[u]);
            ...
            function f(e) {
                var t = e.startDate, n = e.endDate, o = h(t, n);
                return o / v * 100 + "%"
            }
            ...
            function p(e) {
                var t = m.scope.hourStart, n = e.startDate.getHours() + e.startDate.getMinutes() / 60, o = a(t, n);
                return o / v * 100 + "%"
            }

            var m = this.timetable, v = a(m.scope.hourStart, m.scope.hourEnd), E = document.querySelector(e);
